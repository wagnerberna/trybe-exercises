class Deque:
    ...
    # FN insert todas as inserções desse tipo serão adicionadas na posição 0 da estrutura
    def push_front(self, value):
        self._data.insert(self.FIRST_ELEMENT, value)

    # FN append, todas as inserções Sejam adicionadas: na posição n - 1 da estrutura.
    def push_back(self, value):
        self._data.append(value)

    # FN pop remover o elemento existente na posição 0
    def pop_front(self):
        if self._data:
            return self._data.pop(self.FIRST_ELEMENT)
        return None

    # FN pop sem o índice, fazendo com que o elemento da posição n - 1 seja removido.
    def pop_back(self):
        if self._data:
            return self._data.pop()
        return None

    #  visualizar o conteúdo existente nas extremidades
    def peek_front(self):
        if self._data:
